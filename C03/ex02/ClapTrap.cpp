...
/*   Updated: 2020/12/09 12:14:15 by lucaslefran      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(const std::string& name, unsigned int energyPoints /* 100 */, unsigned int maxEnergyPoints /* 100 */,
	unsigned int meleeAttackDamage /* 30 */, unsigned int rangedAttackDamage /* 20 */, unsigned int armorDamageReduction /* 5 */,
	const std::string& type /* "CL4P-TP" */) :  _name(name), _energyPoints(energyPoints),
	_maxEnergyPoints(maxEnergyPoints), _meleeAttackDamage(meleeAttackDamage), _rangedAttackDamage(rangedAttackDamage),
	_armorDamageReduction(armorDamageReduction), _type(type), _hitPoints(100), _maxHitPoints(100), _level(1)
{
	std::cout << "ClapTrap constructor called\n";
}

ClapTrap::ClapTrap(const ClapTrap& copyObj) : _name(copyObj._name), _energyPoints(copyObj._energyPoints),
	...
	_type(copyObj._type), _hitPoints(copyObj._hitPoints), _maxHitPoints(copyObj._maxHitPoints), _level(copyObj._level)
{
