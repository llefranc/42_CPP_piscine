...
/*   Updated: 2020/12/17 17:54:46 by lucaslefran      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	// Handling errors
	form.checkAuthorizations(*this);
	
	// Executing if all authorizations are good
	std::cout << _name << " executes the form " << form.getName() << "\n";
	form.execute(*this);
}
...
Bureaucrat::IsntSigned::IsntSigned() throw() {}

const char* Bureaucrat::IsntSigned::what() const throw()
{
