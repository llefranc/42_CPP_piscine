...
2. `cd` into the root directory, then `cd` into C05 and choose the exercise. Then run `make`.

        cd 42_CPP_piscine/C05/ex00
        makex
...
[1]: https://github.com/lucaslefrancq/42_CPP_piscine/blob/main/C05/cpp05.en.subject.pdf
